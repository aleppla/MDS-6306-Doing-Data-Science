...
#Volleyball Example
```{r}
vball = read.csv('~/MDS-6306-Doing-Data-Science/Unit 7/Bayes Volleyball.csv',header = TRUE)
vball
...
predict(model,vball[,c(1,2)]) #classifications
predict(model,vball[,c(1,2)],type="raw") #probabilities
...
Pnews_word = function(key_word, trainingSet, alphaLaplace = 1, betaLaplace = 1) # alpha and beta are for laplace smoothing to deal with multiplying by 0 probabilities
{
