...
mpg %>% ggplot(aes(x=hwy, y=cty,color=drv)) + geom_point() + geom_smooth()

mpg %>% ggplot() + geom_point(aes(x=hwy, y=cty,color=class)) + geom_smooth(aes(x=hwy, y=cty,linetype=drv), color="black")
...
ggplot(data = mpg) + 
geom_point(mapping = aes(x = hwy, y = cty, color = class)) +
geom_smooth(mapping = aes(x = hwy, y = cty, linetype = class)) + facet_wrap(~class)
...
###My Try
mpg %>% ggplot() + geom_point(aes(x=hwy, y=cty,color=class)) + geom_smooth(aes(x=hwy, y=cty,linetype=drv), color="black") + ggtitle("Scatterplot by Class & Loess Fit by DriveType: City vs. Hwy MPG") + xlab("Highway MPG") + ylab("City MPG")
...
ggplot(data = mpg, aes(x=cty,fill = drv)) + geom_histogram() + facet_grid(drv~class)
